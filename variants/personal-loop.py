"""
Create a Personal Loop agent with the full personality spec (v24).
This is the old-style Loop with humor, opinions, social moments, etc.

Usage:
    pip install letta-client
    export LETTA_API_KEY="your-key"
    python personal-loop.py
"""
...
NOTE_TOOL_PATH = Path(__file__).parent.parent / "note_tool.py"


def create_loop_agent(
    model: str = "anthropic/claude-opus-4-5-20251101",
    embedding: str = "openai/text-embedding-3-small",
    name: str = "Personal Loop",
) -> str:
    """Create a Personal Loop agent and return agent_id."""
